      ...
      <div className= {menuIcon ? "navbar active" : "navbar"}>
        <ul className='navbar-lists'>
...

          {
            isAuthenticated ? (
              <li>
                <Button style={{padding: "1rem"}} onClick={() => logout({returnTo: window.location.origin})}>Logout</Button>
              </li>
            ) : (
              <li>
                <Button style={{padding: "1rem"}} onClick={() => loginWithRedirect()}>Login</Button>
              </li>
            )
          }
